...
[ApiController]
[Route("[controller]")]
public class ExamController(IExamService service):Controller
{
    [HttpGet("get-all")]
    ...
    [HttpPost("add")]
    public async Task<IActionResult> Add(ExamCreateDto exam)
    {
        return Ok(await service.Add(exam));
    }
    [HttpPut("update")]
    public async Task<IActionResult> Update(ExamCreateDto exam)
    {
